...
userRouter.put('/updatePassword', function (req, res)
{
    var userName = req.body.user_name;
    var userPassword = req.body.user_password;
    ...
    {
        dbConn.getDbConnection(dbQuery.putUserPasswordUpdate, req, res);
    }
});

// update email
// PUT: http://localhost:3000/users/updateEmail
userRouter.put('/updateEmail', function (req, res)
{
    var userName = req.body.user_name;
    var userEmail = req.body.user_email;
    ...
    {
        dbConn.getDbConnection(dbQuery.putUserEmailUpdate, req, res);
    }
});
...
userRouter.put('/update', function (req, res)
{
    ...
    {
        dbConn.getDbConnection(dbQuery.putUserTotalUpdate, req, res);
    }
});

//or Update one or the other
...
userRouter.put('/:user_id', function (req, res)
{
    ...
    {
        dbConn.getDbConnection(dbQuery.putOneOrTheOther, req, res);
    }
});
// delete
